...
EXPORTVARS ?= "PN PE PV PR SECTION PRIORITY HOMEPAGE SRC_URI LICENSE SUMMARY DESCRIPTION DEPENDS RDEPENDS FILE S B P UNPACKDIR PACKAGES PROVIDES RPROVIDES RRECOMMENDS"
